...
const Mypage = () => {
    ...
    const handleDeleteAccount = async () => {
        ...
        if (window.confirm("정말 회원탈퇴하시겠습니까?")) {
            try {
                ...
                // 서버에 회원 정보 삭제 요청
                const deleteResponse = await axios.delete(`http://172.30.1.9:8085/member/delete?member_seq=${userSeq}`);
    ...
    const logoutURL =
        "https://kauth.kakao.com/oauth/logout?client_id=05e6f6ac6b8cd6cf3b1ec2a9ca6542de&logout_redirect_uri=http://172.30.1.9:3000/auth/kakao/logout";
