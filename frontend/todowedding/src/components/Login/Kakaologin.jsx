...
const Kakaologin = () => {
    ...
    const loginURL = `https://kauth.kakao.com/oauth/authorize?client_id=05e6f6ac6b8cd6cf3b1ec2a9ca6542de&redirect_uri=http://172.30.1.9:3000/auth/kakao/callback&response_type=code`;
