...
const Kakaologin = () => {
    ...
    const logoutURL = 'https://kauth.kakao.com/oauth/logout?client_id=05e6f6ac6b8cd6cf3b1ec2a9ca6542de&logout_redirect_uri=http://localhost:3000/auth/kakao/logout'
  ...
  return (
    ...
    <div>
        ...
        <a href={logoutURL}><button>카카오 로그아웃</button></a>
