...
const UpdateSchedule = () => {
    ...
    const REDIRECT_URI = "http://3.36.116.165:3000/auth/kakaoCal/callback";
    ...
    const updateSchedule = async (e) => {
        ...
        if (title === "" || startDate === "" || endDate === "") {
            ...
            try {
                await axios.put(`http://3.36.116.165:8085/schedule/${scheduleSeq}`, {
    ...
    const deleteSchedule = async () => {
        try {
            await axios.delete(`http://3.36.116.165:8085/schedule/${scheduleSeq}`);
