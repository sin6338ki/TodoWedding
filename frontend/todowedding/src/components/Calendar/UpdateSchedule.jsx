...
const UpdateSchedule = () => {
    ...
    const URL = `https://kauth.kakao.com/oauth/authorize?client_id=${REST_API_KEY}&redirect_uri=${process.env.REACT_APP_CAL_REDIRECT_URI}&response_type=code&scope=talk_calendar`;
    ...
    const updateSchedule = async (e) => {
        ...
        if (title === "" || startDate === "" || endDate === "") {
            ...
            try {
                await axios.put(`${process.env.REACT_APP_API_URL}/schedule/${scheduleSeq}`, {
    ...
    const deleteSchedule = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/schedule/${scheduleSeq}`);
