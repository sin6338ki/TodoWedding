...
const UpdateSchedule = () => {
    ...
    const REDIRECT_URI = "http://172.30.1.9:3000/auth/kakaoCal/callback";
    ...
    const updateSchedule = async (e) => {
        ...
        if (title === "" || startDate === "" || endDate === "") {
            ...
            try {
                await axios.put(`http://172.30.1.9:8085/schedule/${scheduleSeq}`, {
    ...
    const deleteSchedule = async () => {
        try {
            await axios.delete(`http://172.30.1.9:8085/schedule/${scheduleSeq}`);
