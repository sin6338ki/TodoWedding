...
const PartnerList = ({ partners, setPartners, findAllPartner }) => {
            ...
            {partners.map((partner, idx) => {
                return (
                    ...
                    >
                        ...
                        <div className="text-center col-span-1 mt-2 text-xs">{partner.partner_code}</div>
                        <div className="text-center col-span-2 mt-2 text-xs">{partner.partner_id}</div>
                        <div className="text-center col-span-2 mt-2 text-xs">{partner.partner_name}</div>
                        <div className="text-center col-span-3 mt-2 text-xs">{partner.partner_tel}</div>
                        <div className="text-center col-span-3 mt-2 text-xs">{partner.partner_registration}</div>
                    </div>
                );
            })}
        </div>
