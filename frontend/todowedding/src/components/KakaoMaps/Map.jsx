...
const Map = () => {
    ...
    useEffect(() => {
        ...
        const options = {
            center: new kakao.maps.LatLng(35.167194, 126.883570), // 광주 중심 좌표
            ...
            placesArray.forEach((place) => {
                ...
                document.addEventListener("click", function (e) {
                    if (e.target.id === "map_closeBtn") {
                        if (markerInfo.currentOverlay) { // 현재 열린 오버레이가 있다면 닫기
        ...
        if (currentCategory !== "웨딩홀_스튜디오") { // 전체가 아닌 경우만 필터링 진행
